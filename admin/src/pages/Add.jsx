    ...
    >
      ...
      <div className="w-full">
        ...
        <input
          ...
          value={name}
          className="w-full max-w-[500px] px-3 py-2 placeholder:text-pink-300"
          type="text"
      ...
      <button
        type="submit"
        className={`${loading == true ? " bg-slate-500" : " bg-pink-400 hover:bg-pink-500" } w-28 py-3 mt-4 cursor-pointer text-white`}
      >
